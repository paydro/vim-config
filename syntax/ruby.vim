...
if !exists("ruby_no_comment_fold")
  ...
  syn region rubyDocumentation	  start="^=begin\ze\%(\s.*\)\=$" end="^=end.*$" contains=rubySpaceError,rubyTodo,@Spell fold
else
  syn region rubyDocumentation	  start="^=begin\s*$" end="^=end.*$" contains=rubySpaceError,rubyTodo,@Spell
endif
